...
<input type="submit" class="btn btn-primary" value="Enviar" title="to post" />
			...
			?>					
<label style="color: #ffc119;">Enlaces encriptado ilegible +10 like y a favoritos</label><br><textarea class="form-control" cols="100" rows="4"><?php echo "otakufree.com/11/encrypt/encriptar.php?v=".$urlEncode; ?></textarea><br><br>
</div>
								</div>
							</div>
							<div class="row">
